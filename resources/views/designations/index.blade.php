            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Below is a list of all designations.') }}
                    </p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="/">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Designations') }}</li>
                </x-breadcrumb>
            </div>
        </div>
    ...
    <script>
        $('#data-table').DataTable({
            ...
            columns: [
				...
				{
                    data: 'designation_name_short',
                    name: 'designation_name_short',
                },
				{
